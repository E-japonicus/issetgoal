...
/**
 * The main issetgoal configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_issetgoal_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('issetgoalname', 'issetgoal'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'issetgoalname', 'issetgoal');
        ...
        // Adding the rest of issetgoal settings, spreading all them into this fieldset
